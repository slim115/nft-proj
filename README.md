...
### Before we start, we would like to straighten out some terminology: :dart:
...
### Detailed Understanding of the problem: :detective:
...
We initially tried to integrate more with Pendle Environment by using the contract addresses of IPendleLiquidityMiningV2 and the PendleToken already deployed. :bangbang: However, we could not access their contracts when trying to mint or transfer tokens. <br />
